import { FaRegHeart, FaSearch, FaStar, FaTag, FaPlus } from "react-icons/fa";
          ...
          >
            <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="max-w-105">
                ...
                <p className="mt-3 text-[16px] font-medium text-black">$200</p>
            ...
            <div>
              <p className="text-sm mt-5 text-gray-400">
                {" "}
                {recipe.name}: One meal to rule them all! Grab this mega saver
                combo with your choice of 2 veg wraps, Aloo Paratha (2 pcs),
                chole and Curd lunchbox and 2 choco lava cakes. This is just
                bliss on a plate!
              </p>
            </div>
            ...
            <div className="mt-10">
              ...
              <div className="mt-3 flex flex-wrap gap-x-5 gap-y-2">
                {recipe.ingredients?.map((ingredient, index) => (
                  <span key={index} className="text-[13px] text-gray-400">
                    • {ingredient}
                  </span>
                ))}
              </div>
